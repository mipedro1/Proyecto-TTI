...
int I1_Accel_01() {
	...
	Matrix &x=zeros(6,1);
	x(1,1)=4645.04725161806;
	x(2,1)=-2752.21591588204;
	x(3,1)=-7507.99940987031;
	x(4,1)=-5.92414951314006;
	x(5,1)=-2.73076669788113;
	x(6,1)=-2.86933570556259;
	
	
	Matrix &p=zeros(6,1);
	p(1,1)=6221397.62857869;
	p(2,1)=2867713.77965738;
	p(3,1)=3006155.98509949;
	p(4,1)=4645.04725161806;
	p(5,1)=-2752.21591588204;
	p(6,1)=-7507.99940987031;
    _assert(m_equals(Accel(0.0,p),x, 1e-10));
